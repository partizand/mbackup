...
uses SysUtils, Classes, {stdCtrls,} typInfo,
...
chemin:=ExtractFileDir(ParamStr(0))+'\'+nom;
...
begin
 ini:=TIniFile.create(ExtractFileDir(ParamStr(0))+'\'+CUS);
